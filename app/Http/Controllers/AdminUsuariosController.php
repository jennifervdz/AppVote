<?php namespace App\Http\Controllers;
	...
	class AdminUsuariosController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->col[] = array("label"=>"Privileges","name"=>"id_cms_privileges","join"=>"cms_privileges,name");
			...
			$this->form[] = ['label'=>'Foto','name'=>'photo','type'=>'upload','validation'=>'image|max:3000','width'=>'col-sm-10','help'=>'Tipo de imágenes soportados: JPG, JPEG, PNG, GIF, BMP'];
			...
			$this->form[] = ['label'=>'Privilegio','name'=>'id_cms_privileges','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cms_privileges,name'];
