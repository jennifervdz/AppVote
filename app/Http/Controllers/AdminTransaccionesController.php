<?php namespace App\Http\Controllers;
	...
	class AdminTransaccionesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Concepto","name"=>"concepto","join"=>"conceptos,descripcion"];
			$this->col[] = ["label"=>"Valor","name"=>"valor"];
			$this->col[] = ["label"=>"Usuario","name"=>"usuario","join"=>"cms_users,name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Concepto','name'=>'concepto','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'conceptos,descripcion'];
			$this->form[] = ['label'=>'Valor','name'=>'valor','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Usuario','name'=>'usuario','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cms_users,name'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Concepto","name"=>"concepto","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Valor","name"=>"valor","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Usuario","name"=>"usuario","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
